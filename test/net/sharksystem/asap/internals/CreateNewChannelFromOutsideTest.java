...
public class CreateNewChannelFromOutsideTest {
    ...
    public void openMessageExchange() throws IOException, ASAPException, InterruptedException {
        ...
        ASAPInternalPeer aliceEngine = ASAPInternalPeerFS.createASAPPeer(ALICE_ROOT_FOLDER, null);
        ASAPInternalPeer bobEngine = ASAPInternalPeerFS.createASAPPeer(BOB_ROOT_FOLDER, null);
